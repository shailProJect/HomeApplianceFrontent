    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">View all your service bookings.</p>
        </div>
              ...
              <tbody className="divide-y divide-border">
                {userBookings.map((b) => (
                  <tr key={b.id} className="hover:bg-muted/40 transition-colors">
                    ...
                    <td className="px-6 py-4 font-medium text-foreground">{b.service}</td>
                    <td className="px-6 py-4 text-foreground">{b.provider}</td>
